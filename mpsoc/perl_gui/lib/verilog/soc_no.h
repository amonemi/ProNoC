#ifndef SOC_NO_SYSTEM_H
	#define SOC_NO_SYSTEM_H
 ...
 /*  gpo0   */ 
 #define GPO0_BASE_ADDR0 		 	0X91000000
 ...
 /*  int_ctrl0   */ 
 #define INT_CTRL0_BASE_ADDR0 		 	0X9e000000
 #define INT_CTRL0_BASE_ADDR 		 	INT_CTRL0_BASE_ADDR0
 
	#define	 INT_CTRL0_MER		       (*((volatile unsigned int *) (INT_CTRL0_BASE_ADDR	)))
	#define	INT_CTRL0_IER			(*((volatile unsigned int *) (INT_CTRL0_BASE_ADDR+4	)))
	#define 	INT_CTRL0_IAR			(*((volatile unsigned int *) (INT_CTRL0_BASE_ADDR+8	)))
	#define 	INT_CTRL0_IPR			(*((volatile unsigned int *) (INT_CTRL0_BASE_ADDR+12	)))
