...
#simulation parameters:
 ...
 # Simulation parameters:   
	...
	CONGw=2				# congestion data width which is passed between two  neighbouring routers
...
run_sim(){
 ...
 do 
	for	TRAFFIC in "TRANSPOSE2" "TRANSPOSE1" "BIT_REVERSE"  "BIT_COMPLEMENT" "RANDOM" "HOTSPOT"
	do
		for   CONGESTION_INDEX in   1 #0 1 2 3
		do
